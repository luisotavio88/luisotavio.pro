...
Por isso, posso te falar que em pouco tempo você consegue sair do absoluto 0 (o que era o meu caso) e desenvolver um trabalho relevante. 

Fiz esse e-book pensando em tudo o que eu precisaria aprender nesse início, de forma bem prática e sem enrolação. Assim como eu gostaria de ter aprendido nessa época.
...
Então, em 2018 eu sai da ANTT e resolvi me dedicar integralmente ao projeto, aplicando Ciência de Dados ao futebol. 

Hoje em dia uso uma quantidade absurda de automações no Guru do Cartola desenvolvidas exclusivamente usando o R.

O trabalho do Cientista de Dados pode ser bem amplo, existem muitas possibilidades ou áreas de atuação.
