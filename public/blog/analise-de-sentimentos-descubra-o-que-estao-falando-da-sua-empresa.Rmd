...
api_key <- "jKGUXnteqb8U2jumEYt2xlZVB"
api_secret_key <- "F6D844PYuCpQhtKySZ4JRtdYqL2R3KJHweIvtUSMskTJpKAEaE"
access_token <- "898383109191852032-QZxwGXyNgIyaT7I5CvaswORcqIpgezx"
access_token_secret <- "sk6hGHagtvbY3BDfEIHnpWWxNy6UJvvwZG6GWH8sDvjwV"

## authenticate via web browser
# token <- create_token(
#   app = "analise_sentimento_luisotaviopro",
...
## authenticate via web browser
token <- create_token(
  app = "analise_sentimento_luisotaviopro", #substituir pelo nome do seu app
  consumer_key = api_key,
  consumer_secret = api_secret_key,
  access_token = access_token,
  access_secret = access_token_secret)
...
library(ggraph)
 ...
 correlacao %>%
      filter(correlation > .10) %>% #FILTRANDO APENAS QUANDO A CORRELAÇÃO É MAIOR QUE 0,10 - ESCOLHA SEU CRITÉRIO
