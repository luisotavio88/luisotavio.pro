...
O R é utilizado por pessoas da área de economia, previsões do tempo, área de saúde, demografia e várias outras... Sendo que cada uma das áreas citadas ainda tem vários subnichos.
...
Para rodar qualquer código, você poder escrevê-lo no editor e pressionar Crtl + R ou clicar em _Run_, o cursor do mouse deve estar na linha que você deseja executar ou então selecione todo o código que você deseja executar (útil para rodar várias linhas de uma vez).
...
É isso, agora você já sabe como instalar e carregar um pacote no R. 
