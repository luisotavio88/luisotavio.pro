...
No mesmo mês que formei na faculdade veio a minha primeira aprovação: Oficial ESTATÍSTICO da Força Aérea Brasileira. Servi à Aeronáutica por 11 meses. Nesse período, trabalhei no Centro de Inteligência da Aeronáutica coordenando os cursos de Inteligência.
...
<!--chapter:end:assim-que-vou-retweetar-o-que-me-interessa-no-twitter.Rmd-->
...
<!--chapter:end:como-filtrar-os-seus-dados-no-r.Rmd-->
...
[**Já me segue no instagram? Tô sempre postando o que aprendo e desenvolvo como Cientista de Dados.**](https://www.instagram.com/_u/luisotavio.pro)

<!--chapter:end:confirmacao-ebook.Rmd-->
...
<!--chapter:end:confirmacao-formulario.Rmd-->
...
<!--chapter:end:confirmacao.Rmd-->

---
title: Quer dar o seu primeiro passo para ser um Cientista de Dados?
author: ''
date: '2020-01-14'
slug: ebook
categories: []
...
type: semheader
---
<img src="https://www.luisotavio.pro/r-ciencia-de-dados/imagens/capa_livro.png" height="250" alt="Capa o seu primeiro passo como cientista de dados" align="right" style="margin: 0 1em 0 1em" />
...
```{r,echo=FALSE}
library(shiny)
HTML('<section class="section-sm pb-0">
  <div class="container">
