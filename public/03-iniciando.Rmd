...
Também seria possível classificar renda e cursos (ou qualquer variável categórica) como uma variável de texto (*character*). Então para o que serve a classe dos fatores?
